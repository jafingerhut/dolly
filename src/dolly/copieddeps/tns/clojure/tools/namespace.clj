...
(ns 
 ^{:author "Stuart Sierra",
  ...
  other namespaces"}
 dolly.copieddeps.tns.clojure.tools.namespace
...
(defn comment?
  "DEPRECATED; moved to dolly.copieddeps.tns.clojure.tools.namespace.parse
...
(defn read-file-ns-decl
  "DEPRECATED; moved to dolly.copieddeps.tns.clojure.tools.namespace.file
...
(defn find-ns-decls-on-classpath
  "DEPRECATED; use dolly.copieddeps.tns.clojure.tools.namespace.find/find-ns-decls
...
(defn find-namespaces-on-classpath
  "DEPRECATED; use dolly.copieddeps.tns.clojure.tools.namespace.find/find-namespaces
  and clojure.java.classpath/classpath from
  http://github.com/clojure/java.classpath
