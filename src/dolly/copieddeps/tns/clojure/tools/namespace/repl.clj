...
(ns ^{:author "Stuart Sierra"
  ...
  dolly.copieddeps.tns.clojure.tools.namespace.repl
  (:require [dolly.copieddeps.tns.clojure.tools.namespace.track :as track]
            [dolly.copieddeps.tns.clojure.tools.namespace.dir :as dir]
            [dolly.copieddeps.tns.clojure.tools.namespace.reload :as reload]))
